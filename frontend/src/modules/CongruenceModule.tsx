...
export const CongruenceModule: React.FC = () => {
  ...
  return (
    <div className="py-10 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto space-y-10">
      ...
      {/* Title */}
      <div className="animate-fade-up pb-6" style={{ borderBottom: '1px solid var(--border-default)' }}>
        <span className="neon-pill neon-pill-purple mb-3 inline-flex">Unit I · Modular Arithmetic</span>
        <h1 className="section-heading text-3xl sm:text-4xl font-black mt-2" style={{ color: 'var(--text-primary)' }}>
        ...
        <div className="lg:col-span-2 space-y-8">
          {response ? (
            <div className="glass-card p-6 sm:p-8  space-y-8">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start glass-card-inner p-6">
